...
FileList::FileList(FXWindow* focuswin, FXComposite *p, FXObject* tgt, FXSelector sel, FXbool showthumbs, FXuint opts, FXint x, FXint y, FXint w, FXint h):
...
long FileList::onDNDDrop(FXObject* sender,FXSelector sel,void* ptr)
{
    ...
    if(getDNDData(FROM_DRAGNDROP,urilistType,data,len))
    {
		...
		while(*p)
        {
            ...
            FXString target(targetdir+PATHSEPSTRING+FXPath::name(source));
...
// Compare file names
FXint FileList::ascending(const IconItem* pa,const IconItem* pb)
{
...
FXint FileList::ascendingMix(const IconItem* pa,const IconItem* pb)
{
...
FXint FileList::ascendingCase(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::ascendingCaseMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::ascendingDir(const IconItem* pa,const IconItem* pb)
{
...
FXint FileList::ascendingDirMix(const IconItem* pa,const IconItem* pb)
{
...
FXint FileList::ascendingDirCase(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingDirCaseMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
// Compare file types
FXint FileList::ascendingType(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingTypeMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingExt(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingExtMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingSize(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
	...
	register FXint diff=(FXint)b->isDirectory() - (FXint)a->isDirectory();
	register FXint sum=(FXint)b->isDirectory() + (FXint)a->isDirectory();
...
FXint FileList::ascendingSizeMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    ...
    register const unsigned char *p=(const unsigned char*)a->label.text();
    register const unsigned char *q=(const unsigned char*)b->label.text();
	register FXint adir=(FXint)a->isDirectory();
	register FXint bdir=(FXint)b->isDirectory();
...
// Compare file time
FXint FileList::ascendingTime(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::ascendingTimeMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
// Compare file user
FXint FileList::ascendingUser(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingUserMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
// Compare file group
FXint FileList::ascendingGroup(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingGroupMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingPerm(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingPermMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingDeltime(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::ascendingDeltimeMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::ascendingOrigpath(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::ascendingOrigpathMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingCase(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descendingCaseMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descending(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descendingMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descendingDirCase(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingDirCaseMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingDir(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingDirMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingType(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingTypeMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingExt(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingExtMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingSize(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descendingSizeMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descendingTime(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descendingTimeMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descendingUser(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingUserMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingGroup(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingGroupMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingPerm(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingPermMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingDeltime(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descendingDeltimeMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
...
FXint FileList::descendingOrigpath(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
FXint FileList::descendingOrigpathMix(const IconItem* pa,const IconItem* pb)
{
    register const FileItem *a=(FileItem*)pa;
    register const FileItem *b=(FileItem*)pb;
    register const unsigned char *p=(const unsigned char*)a->label.text();
...
// Is link
FXbool FileList::isItemLink(FXint index) const
{
	if ((unsigned int)index >= (unsigned int)items.no())
...
FXString FileList::getItemFullPathname(FXint index) const
{
	if ((unsigned int)index >= (unsigned int)items.no())
...
// Change header size
void FileList::setHeaderSize(FXint index,FXint size)
{
    if (index==NB_HEADERS)
		origpathsize=size;
...
// Get header size
FXint FileList::getHeaderSize(FXint index) const
{
	if (index==NB_HEADERS)
		return origpathsize;
