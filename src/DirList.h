...
protected:
    ...
    TreeItem* getitem(FXchar* pathname);
    void listRootItems();
...
public:
    ...
    DirList(FXWindow *focuswin,FXComposite *p,FXObject* tgt=NULL,FXSelector sel=0,FXuint opts=0,FXint x=0,FXint y=0,FXint w=0,FXint h=0);
