...
public:
	...
	// Get current item
	FXint getCurrentItem(void) const
	{
		return list->getCurrentItem();
	}

	// Set current item
	void setCurrentItem(FXint item)
	{
	...
	// Select item
	void selectItem(FXint item)
	{
		list->selectItem(item);
	}

	// Deselect item
	void deselectItem(FXint item)
	{
		list->deselectItem(item);
	}

	// Is item selected?
	FXbool isItemSelected(FXint item)
	{
	...
	FXint getNumSelectedItems(void)
	{
	...
	FXint backhistGetNumItems(void)
	{
		if (list->backhist)
	...
	FXint forwardhistGetNumItems(void)
	{
		if (list->forwardhist)
	...
	StringItem* backhistGetItemAtPos(FXint pos)
	{
		return list->backhist->getItemAtPos(pos);
	}

	// Get forward history item at position pos
	StringItem* forwardhistGetItemAtPos(FXint pos)
	{
