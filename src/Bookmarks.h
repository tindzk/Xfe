...
protected:
    ...
    FXint       maxbookmarks;       // Maximum number of bookmarks to track
private:
...
public:
    ...
    void setMaxBookmarks(FXint mx)
    {
        maxbookmarks=mx;
    }

    // Return the maximum number of bookmarks being tracked
    FXint getMaxBookmarks() const
    {
        return maxbookmarks;
    }
    ...
    FXString getBookmark(FXint index) const;

    // Change the bookmark name at index
    void setBookmark(FXint index,const FXString& filename);
