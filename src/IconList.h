...
protected:
    ...
    virtual void drawMiniIcon(const IconList* list,FXDC& dc,FXint x,FXint y,FXint w,FXint h) const;
	FXbool isOdd(FXint i) const;
    virtual void drawDetails(IconList* list,FXDC& dc,FXint x,FXint y,FXint w,FXint h) const;
public:
    enum
    {
        SELECTED      = 1,  // Selected
...
public:
    ...
    virtual FXint getWidth(const IconList* list) const;

    // Return height of item as drawn in list
    virtual FXint getHeight(const IconList* list) const;
...
typedef FXint (*IconListSortFunc)(const IconItem*,const IconItem*);
...
protected:
	...
	FXdouble           headerpct[10];     // Header sizes, relatively to the list width (in percent)
	FXint			   count;             // Counter used to properly initialize the relative header sizes
	FXbool 			   autosize;
...
public:
    static FXint ascending(const IconItem* a,const IconItem* b);
    static FXint descending(const IconItem* a,const IconItem* b);
    static FXint ascendingCase(const IconItem* a,const IconItem* b);
    static FXint descendingCase(const IconItem* a,const IconItem* b);
public:
    enum
    {
...
public:
    ...
    IconList(FXComposite *p,FXObject* tgt=NULL,FXSelector sel=0,FXuint opts=_ICONLIST_NORMAL,FXint x=0,FXint y=0,FXint w=0,FXint h=0);
    ...
    IconItem *getItem(FXint index) const;

    // Replace the item with a [possibly subclassed] item
    FXint setItem(FXint index,IconItem* item,FXbool notify=FALSE);
    ...
    FXint insertItem(FXint index,IconItem* item,FXbool notify=FALSE);
    ...
    FXint appendItem(IconItem* item,FXbool notify=FALSE);
    ...
    FXint prependItem(IconItem* item,FXbool notify=FALSE);
    ...
    IconItem* extractItem(FXint index,FXbool notify=FALSE);
