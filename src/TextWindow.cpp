...
TextWindow::TextWindow(FXWindow *owner, const FXString& name, FXint nblines, FXint nbcols):
...
// Construct Text dialog box
TextWindow::TextWindow(FXApp* app, const FXString& name, FXint nblines, FXint nbcols):
...
void TextWindow::setText(const FXchar* str)
{
...
void TextWindow::appendText(const FXchar* str)
{
...
// Get text length
FXint TextWindow::getLength(void)
{
